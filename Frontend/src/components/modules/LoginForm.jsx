  ...
  return (
    <div className="flex items-center justify-center min-h-screen ">
      <div className="w-full max-w-md p-6 bg-black/40  backdrop-blur-sm rounded-2xl shadow-xl">
        ...
        {/* Display Error */}
        {error && (
          <div className="mb-4 text-sm text-red-500 bg-red-100 bg-opacity-20 border border-red-500 rounded-full px-4 py-2">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full mt-1 px-4 py-2   rounded-full focus:ring-yellow-500 focus:border-yellow-500"
            >
          ...
          <button
            type="submit"
            className="w-full px-4 py-2  bg-yellow-500 hover:bg-yellow-600 font-semibold rounded-full shadow-md transition-all duration-300"
          >
            Login
          </button>
        </form>
